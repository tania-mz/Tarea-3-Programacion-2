...
//Funcion que imprime los espacios especificados
...
//Funcion que imprime las letras "P" especificadas
...
//Funcion que imprime el triangulo mostrado en el diseño de pantalla
void PrintTriangle(int amountP, int amountSpaces){
    if(amountSpaces < 7){
        PrintSpaces(amountSpaces, 0),
        PrintP(amountP, 0);
        printf("\n");
        PrintTriangle(amountP-2, amountSpaces+1);
    }
}
